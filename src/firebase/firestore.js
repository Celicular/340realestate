...
export const addSaleProperty = async (saleData, agentInfo) => {
  try {
    console.log(
      "Adding sale property to collection:",
      SALE_PROPERTIES_COLLECTION
    );
...
// ===============================================
export const adminUpdateRentalProperty = async (
  rentalId,
  updateData,
  adminInfo = {}
) => {
...
export const adminUpdateRentalPropertyAll = async (
  rentalId,
  data,
  adminInfo = {}
) => {
...
export const updateRentalPropertyStatus = async (
  rentalId,
  status,
  adminNotes = ""
) => {
...
export const updateSalePropertyStatus = async (
  saleId,
  status,
  adminNotes = ""
) => {
...
export const subscribeToReviews = (callback) => {
  ...
  return onSnapshot(q, (querySnapshot) => {
    console.log(
      "Firebase reviews snapshot received, docs count:",
      querySnapshot.size
    );
    const reviews = [];
    querySnapshot.forEach((doc) => {
...
export const updateVillaBookingRequestStatus = async (
  bookingId,
  status,
  adminNotes = ""
) => {
...
export const getAllPortfolioItems = async (filters = {}) => {
  try {
    ...
    for (const cat of categories) {
      const result = await getPortfolioItems(cat, filters);
